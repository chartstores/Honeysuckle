 ...
 *
 * 2013/11/05
 * 1、在touchmove事件回调中，增加自定义scrollMove事件 :517行
 * 2、增加一个disableResize选项，默认false，解决问题：如果IScroll实例处于隐藏状态，resize事件回调会导致IScroll计算出错 :277行 :842行
 *
 */
...
var IScroll = (function (window, document, Math) {
    ...
    IScroll.prototype = {
        ...
        _initEvents: function (remove) {
            ...
            if ( this.options.disableResize !== true ) {
